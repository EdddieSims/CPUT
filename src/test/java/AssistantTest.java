...
public class AssistantTest {
    ...
    {
        Assistant ass23 = new Assistant.BuildMe("Part-time Worker").name("Meena Waggie").build();
        Assistant ass2 = new Assistant.BuildMe("Part-time Worker").assi(ass23).name("Muneem Waggie").build();
